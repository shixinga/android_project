...
public class MyFlushListView extends ListView implements OnScrollListener{
	...
	//布局文件中用style时调用的方法
	public MyFlushListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	//布局文件中用属性时调用的方法
	public MyFlushListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	//在代码中调用的方法
	public MyFlushListView(Context context) {
		super(context);
		init();
	}
